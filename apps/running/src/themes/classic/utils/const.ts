import { getSiteTheme } from '@/site/appearance';
// Constants
const MAPBOX_TOKEN =
...
export const RUN_COLOR_LIGHT = '#3e674c';
export const RUN_COLOR_DARK = '#b4cfa7';
...
export const getRuntimeRunColor = (): string => {
  ...
  const isDark = getSiteTheme() === 'dark';
...
export const MAP_TILE_VENDOR: string = 'mapcn_openfreemap';
